...
export default function Footer() {
  ...
  return (
    <Box className="negative" title={name + domain} subtitle>
      <p>created by <Link href="/user/meowcatheorange" target="_blank">MeowcaTheoRange</Link> and <Link href="/user/redact" target="_blank">Redact4K</Link>.</p>
      <p>The {name} name is derived from the original <Link href="http://hs.trollcall.xyz/">Hiveswap Troll Call</Link>. The name may be used in an entity context or a project context.<br />Homestuck and HIVESWAP © Homestuck Inc.</p>
      <p className="subtitle pt-2">OTHER COOL THINGS</p>
      {map}
      <details><summary>Technical</summary>
        <p>NPM entry: {publicRuntimeConfig.name} {publicRuntimeConfig.version}</p>
